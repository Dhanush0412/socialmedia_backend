...
let {createprofile,getdashboard,updatedprofilepic,bioupdate,profileedit,updatetheme,gettheme,changepassword,deleteaccount} = require("../controllers/profilecontroller");
...
router.delete("/deleteacc",verifytoken,deleteaccount)
